...
- Transforms applied on sync: `~~/shaders/hdr-toys/` → `C:/mpv/portable_config/shaders/hdr-toys/` (portable `~~/` sometimes fails) and `gamut-mapping/bottosson.glsl` → `gamut-mapping/jedypod.glsl` (upstream v2504 note). See `Update-MpvEnvironment.ps1:270-273`
