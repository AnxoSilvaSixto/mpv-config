-- !!! AUTO-MANAGED by Update-MpvEnvironment.ps1 !!!
-- Synced from upstream Chinna95P/mpv-anime-build (scripts/skip_intro.lua) with local NieR palette; manual edits will be LOST.
-- [[ 
...
local function draw_button(label, remaining, is_hovering)
    ...
    if is_hovering then
        ...
        local specific_color = label_colors[label] or "48628a"
...
local function skip_action()
    ...
    local color = label_colors[state.active_label] or "48628a"
